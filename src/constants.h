...
const graphs::RectX SCREEN_RC(0,0,SCREEN_X,SCREEN_Y);
const graphs::RectX ZERO_RC(ZERO_PT, ZERO_PT);

const graphs::RectX TOOLWND_RC(0, 0, 313, 30);     //工具栏窗口大小
const graphs::RectX TOOLBAR_RC(1, 1, 312, 27);     //工具栏大小
const graphs::RectX COLORWND_RC(0, 0, 240, 34);    //颜色选择框
